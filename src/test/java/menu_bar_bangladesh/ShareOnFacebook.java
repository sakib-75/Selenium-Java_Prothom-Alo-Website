...
public class ShareOnFacebook extends Politics {
    @Test
    public void shareOnFacebook() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(menuBd.facebookShare())).click();
